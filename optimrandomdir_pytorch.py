...
import optimrandomdir #with no parallel cpu processing, good for simple error functions
#import optimrandomdir_keepcoeffset as optimrandomdir
#import optimrandomdir_stdevevol as optimrandomdir #evolution of standard deviations
#import optimrandomdir_updatescale as optimrandomdir #updating scale of updated of standard deviations, doesn't really work

optimrandomdir.iterations=100
optimrandomdir.startingscale=2.0
optimrandomdir.endscale=1.0
import torch
import numpy as np
...
def optimizer(model, loss_fn, X, Y, iterations=100, startingscale=1.0, endscale=0.0):
   ...
   subiterations=1
   for iter in range(subiterations):
      weightsarray=optimrandomdir.optimrandomdir(torcherrorfunction, weightsarray, args=(model, loss_fn, X, Y), iterations=iterations//subiterations, startingscale=startingscale, endscale=endscale)
   weightsmin=weightsarray
